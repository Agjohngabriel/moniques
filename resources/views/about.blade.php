<!--
	Author:http:g.page/iihubafrica
	Author URL:http:g.page/iihubafricam
...
<html lang="en">
<head>
<title>Monique Motors Ltd  | About :: </title>
			...
			<div class="row about-grids-bottom text-left">
				...
				<div class="col-md-4 about-bottom-grid">
					<p>VISION:
						...
						To grow in a steady and responsible pace to a position of strength and prominence in our areas of operation.</p>
				</div>
			</div>
		</div>
...
<section class="food-Slider py-5">
	<div class="container py-lg-5">
		<h3 class="heading text-capitalize text-center">Our Motors</h3>
		<h5 class="heading mb-5 text-center">Monique Motors</h5>
			...
			<div class="carousel-inner">
				<div class="carousel-item active">
					<div class="row">
						<div class="col-md-4 col-sm-6 slidering">
							...
							<h5 class="my-2 text-center text-uppercase">Sienna </h5>
						</div>
						<div class="col-md-4 col-sm-6 slidering">
							<div class="thumbnail"><img src="images/2.png" alt="Image" style="max-width:100%;"></div>
							<h5 class="my-2 text-center text-uppercase">Hiace </h5>
						</div>
						<div class="col-md-4 col-sm-6 slidering">
							<div class="thumbnail"><img src="images/3.png" alt="Image" style="max-width:100%;"></div>
							<h5 class="my-2 text-center text-uppercase">Hummer Bus </h5>
						</div>
					</div>
				</div>
				<div class="carousel-item">
					<div class="row">
						...
						<div class="col-md-4 col-sm-6 slidering">
							<div class="thumbnail"><img src="images/3.png" alt="Image" style="max-width:100%;"></div>
							<h5 class="my-2 text-center text-uppercase">Hummer </h5>
						</div>
					</div>
				</div>
				<div class="carousel-item">
...
<section class="container py-3">
	<div class="booking text-center p-sm-5 py-5 px-3">
		<h3>Book Our Motors Now</h3>
		<p class="my-4">Our booking system is now available to use. You can book a ride to any destination of your choice. Its free and there are no charges attached to it. After payment which you will present to the help desk as evidence of payment so as to confirm your payment in our database. </p>
...
<section class="wthree-row py-5">
	<div class="container py-md-5 py-3">
		...
		<h5 class="heading mb-5 text-center">Monique Drivers</h5>
	...
	<div class="container-fluid pt-lg-5">
		<div class="row">
			<div class="col-lg-3 col-sm-6 mb-lg-0 mb-5 footer-grid-agileits-w3ls1 text-left">
				...
				<p>The guiding percepts that MML lives by in its day-today life are best expressed in the company’s statement of its vision and mission. </p>
			...
			<div class="col-lg-3 col-sm-6 mb-lg-0 mb-5 footer-grid-agileits-w3ls1 text-left">
				...
				<ul class="w3ls-footer-bottom-list">
					...
					<li> <span class="fas fa-envelope"></span> <a href="moniquemotorslimited@gmail.com.com"> moniquemotorslimited@gmail.com</a> </li>
		...
		<div class="footer-cpy text-center pt-sm-5 mt-sm-5 mt-4 pt-3">
			<div class="w3layouts-agile-copyrightbottom">
				<p>© 2020 Moninique Motors. All Rights Reserved | Design by 
