    ...
    <div class="row row-height">
        ...
        <div class="col-lg-6 content-right" id="start">
            <div id="wizard_container">
                ...
                <!-- /top-wizard -->
                <form id="wrapped" method="POST" action="/detail">
                    @csrf
                    ...
                    <div id="middle-wizard">
                        ...
                        <div class="submit step">
                            ...
                            <div class="form-group">
                                <input type="phone" name="phone" class="form-control" placeholder="Telephone">
            ...
            <div class="footer">
                <ul>
                    ...
                    <li><a href="https://1.envato.market/azxyb" class="animated_link" target="_parent">Buy this Template</a></li>
                </ul>
                <em>© 2019 Melkin</em>
            </div>
            <!-- Footer -->
