<!--
    Author:iihubafrica
    Author URL: http:g.page/iihubafrica
...
<html lang="en">
<head>
<title>MONIQUE MOTORS LTD | Home </title>
                        ...
                        <div class="banner-img">
                            <div class="bs-slider-overlay">
                                <div class="banner-info text-center">
                                    ...
                                    <h1>24/7 Transport Service </h1>
                                    <h2 class="mb-5"><i class="fas fa-phone"></i> +234 (816) 931 8651</h2>
                        ...
                        <div class="banner-img one">
                            <div class="bs-slider-overlay">
                                <div class="banner-info text-center">
                                    ...
                                    <h4>Monique Motors Online Booking</h4>
                        ...
                        <div class="banner-img three">
                            <div class="bs-slider-overlay">
                                <div class="banner-info text-center">
                                    ...
                                    <h5 class="mb-5">Best Transport Service</h5>
                                    <a href="/booking">Book Now </a>
                                </div>
                            </div>
                        </div>
...
<section class="about py-5">
    <div class="container py-lg-5 py-3">
        ...
        <h5 class="heading mb-5 text-center">Monique Motors</h5>
        <div class="about-head text-center ">
            ...
            <div class="row about-grids-bottom text-left">
                <div class="col-md-4 mb-md-0 mb-5 about-bottom-grid">
                    <h4 class="mb-4">LEAVE THE ROAD TO US.</h4>
                    <a href="/about"> More About Us</a> 
                </div>
                <div class="col-md-4 about-bottom-grid">
                    <p>MONIQUE MOTORS LIMITED is one of the transport and logistics companies in Nigeria serving the riding public en-route to southern and Northern states which includes key destinations such as Abuja, Lokoja, Asaba, Onitsha, Owerri, Aba, Portharcourt and Lagos.</p>
                </div>
                <div class="col-md-4 about-bottom-grid">
                    <p>VISION:
                        To be customer's obvious choice by providing total transport and logistics solutions through Innovative and reliable service.
...
<section class="why">
    <div class="container-fluid p-md-5 p-3">
        <h3 class="heading text-capitalize text-center">Why Monique Motors</h3>
        <h5 class="heading mb-5 text-center">Monique Motors</h5>
        <div class="row why-grids">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6">
                <div class="py-5 px-2 mb-md-0 mb-4 grid6 text-center">
                    ...
                    <p class="mt-5">Best Quality Motors</p>
                </div>
            </div>
            <div class="col-lg-3 col-md-4 col-sm-6">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6">
                <div class="py-5 px-2 grid8 text-center">
                    ...
                    <p class="mt-5">24/7 Transport & Logistics Service</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row text-center">
            <div class="col-lg-3 col-sm-6 col-6 team-grids">
                ...
                <div class="footerv2-w3ls mt-3">
                    <h4>Our Drivers</h4>
                    <p class="my-2">Monique Driver</p>
                    <p><i class="fas fa-phone" aria-hidden="true"></i> +234 (816) 931 8651</p>
                </div>
                <!-- //team text -->
            </div>
            <div class="col-lg-3 col-sm-6 col-6 team-grids">
    ...
    <div class="container py-lg-5 py-3">
        ...
        <div class="row pricing-grids">
            <div class="col-lg-3 col-md-6 price-grid">
                <h3 class="mb-4">Sienna -- <span class="">#10,000</span></h3>
                <h4 class="my-3">Aba to lagos</h4>
                <p> Comfortable and firstclass Sienna with Ac and Feeding support.</p>
            ...
            <div class="col-lg-3 col-md-6 mt-md-0 mt-5 price-grid">
                <h3 class="mb-4">Hiace -- <span class="">#15,000</span></h3>
                <h4 class="my-3">Lagos to Abuja</h4>
                <p> Fast and Furious Haice vehicle with relaxation seats, Ac and feeding support. </p>
                <ul class="d-flex mt-3">
                    <li class="mr-3">2 <i class="fas fa-male" aria-hidden="true"></i></li>
            ...
            <div class="col-lg-3 col-md-6 mt-lg-0 mt-5 price-grid">
                <h3 class="mb-4">Sienna -- <span class="">#12,000</span></h3>
                <h4 class="my-3">Lagos to Umuahia and Mbaise</h4>
                <p> Comfortable, reliable and full Ac vehicle with feeding assured.</p>
                <ul class="d-flex mt-3">
            ...
            <div class="col-lg-3 col-md-6 mt-lg-0 mt-5 price-grid">
                <h3 class="mb-4">Monique Special Vehicles -- <span class="">#15,000</span></h3>
                <h4 class="my-3">Abuja to Lagos or Aba</h4>
                <p>Full Air conditioned vehicle, customer service and feeding assured</p>
                <ul class="d-flex mt-3">
        ...
        <div class="inner-sec-w3layouts-agileits">
            <div class="owl-carousel owl-theme">
                <div class="item">
                    <div class="feedback-info">
                        <div class="feedback-top p-4">
                            <p> This is the best transport company I admire. </p>
                        </div>
                        <div class="feedback-grids">
                            <div class="feedback-img">
                                <img src="images/IMG_-bnjrjs.jpg" class="img-fluid" alt="" />
                            </div>
                ...
                <div class="item">
                    <div class="feedback-info">
                        <div class="feedback-top p-4">
                            <p> My first experience with Monique Motors was exciting and worth repeating. </p>
                        </div>
                        <div class="feedback-grids">
                            <div class="feedback-img">
                                <img src="images/eye-for-ebony-aZzXKGcyWqk-unsplash.jpg" class="img-fluid" alt="" />
                            </div>
                            <div class="feedback-img-info">
                                <h5>Excel Anyanwu</h5>
                                <p>Customer</p>
                ...
                <div class="item">
                    <div class="feedback-info">
                        <div class="feedback-top p-4">
                            <p> Their customer service is quality rated I must admit. </p>
                        </div>
                        <div class="feedback-grids">
                            <div class="feedback-img">
                                <img src="images/alex-robinson-rrI02QQ9GSQ-unsplash.jpg" class="img-fluid" alt="" />
                            </div>
                            <div class="feedback-img-info">
                                <h5> Alex Daniels</h5>
                                <p>Customer</p>
                ...
                <div class="item">
                    <div class="feedback-info">
                        <div class="feedback-top p-4">
                            <p>Monique Motors has one of the best vehicles you always wish to travel with . </p>
                        </div>
                        <div class="feedback-grids">
                            <div class="feedback-img">
                                <img src="images/efizzy.jpg" class="img-fluid" alt="" />
                            </div>
                            <div class="feedback-img-info">
                                <h5>Ifeanyi Kalu</h5>
                                <p>Customer</p>
                ...
                <div class="item">
                    <div class="feedback-info">
                        <div class="feedback-top p-4">
                            <p> My first encounter with them was exciting. </p>
                        </div>
                        <div class="feedback-grids">
                            <div class="feedback-img">
                                <img src="images/leon-ell-C8Q_zR8PDlA-unsplash.jpg" class="img-fluid" alt="" />
                            </div>
                            <div class="feedback-img-info">
                                <h5>Jane Amaechi</h5>
                                <p>Customer</p>
                ...
                <div class="item">
                    <div class="feedback-info">
                        <div class="feedback-top p-4 p-4">
                            <p> I would want to recommend them and rate their services as the best. </p>
                        </div>
                        <div class="feedback-grids">
                            <div class="feedback-img">
                                <img src="images/woman.jpg" class="img-fluid" alt="" />
                            </div>
                            <div class="feedback-img-info">
                                <h5>Joy Chidi</h5>
                                <p>Customer</p>
    ...
    <div class="container-fluid pt-lg-5">
        <div class="row">
            <div class="col-lg-3 col-sm-6 mb-lg-0 mb-5 footer-grid-agileits-w3ls1 text-left">
                <h3 class="mb-sm-5 mb-4 mt-sm-0 mt-4">About Monique Motors</h3> 
                <p>MONIQUE MOTOR LIMITED carries an unbroken tradition of providing transport services in Northern and Southern states. Through the entrepreneurial acumen, determination and sheer hard work of its founders, a vision was transformed into what the company is now: a thriving and expanding enterprise committed to provide superior transport services to the riding public.
                    MML’s beginnings started in June 2020 as an operating limited liability company.
                    </p>
            ...
            <div class="col-lg-3 col-sm-6 mb-lg-0 mb-5 footer-grid-agileits-w3ls1 text-left">
                ...
                <ul class="w3ls-footer-bottom-list">
                    <li> <span class="fas fa-map-marker"></span> 32 Ijaiye Road opposite tantalizer fast-food ogba<span> Lagos, Nigeria </span></li>
                    <li> <span class="fas fa-envelope"></span> <a href="/mailto: moniquemotorslimited@gmail.com"> moniquemotorslimited@gmail.com</a> </li>
                    <li> <span class="fas fa-phone"></span> +234 (816) 931 8651 </li>
                    <li> <span class="fas fa-fax"></span> +234 (816) 931 8651 </li>
                    <li> <span class="fas fa-globe"></span> <a href="/#"> www.moniquemotorsltd.com.ng</a> </li>
            ...
            <div class="col-lg-3 col-sm-6 mb-sm-0 mb-5 footer-grid-agileits-w3ls text-left">
                <div class="tech-btm">
                    ...
                    <div class="blog-grids row mb-3"></div>
                        ...
                        <h5>
                            ...
                            <div class="sub-meta">
                                <span>
                                    <i class="far fa-clock"></i> 19 Apr, 2020</span>
                            </div>
                        </div>
                    ...
                    <div class="blog-grids row mb-3">
                        ...
                        <div class="col-8 blog-grid-right">
                            ...
                            <div class="sub-meta">
                                <span>
                                    <i class="far fa-clock"></i> 20 Apr, 2020</span>
                            </div>
                    ...
                    <div class="blog-grids row">
                        ...
                        <div class="col-8 blog-grid-right">
                            ...
                            <div class="sub-meta">
                                <span>
                                    <i class="far fa-clock"></i> 21 Apr, 2020</span>
                            </div>
                        </div>
            ...
            <div class="col-lg-3 col-sm-6 subscribe-main footer-grid-agileits-w3ls text-left">
                ...
                <h3 class="mb-sm-5 mb-4">Stay In Touch</h3>
                    <ul>
                        <li class="mr-1">
                            <a class="facebook" href="/https://www.facebook.com/moniquemotorslimited/?ref=py_c">
                        ...
                        <li class="mr-1">
                            <a class="facebook" href="/https://www.instagram.com/moniquemotorslimited/">
                                <i class="fab fa-google-plus-g"></i>
                            </a>
                        </li>
                        <li class="mr-1">
                            <a class="facebook" href="/https://www.linkedin.com/company/monique-motors-lt">
        ...
        <div class="footer-cpy text-center pt-sm-5 mt-sm-5 mt-4 pt-3">
            <div class="w3layouts-agile-copyrightbottom">
                <p>© 2020 Monique Motors Ltd. All Rights Reserved | Design by
                    <a href="/http:g.page/iihubafrica">IihubAfrica</a>
                </p>
